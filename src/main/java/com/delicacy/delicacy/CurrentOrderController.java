...
public class CurrentOrderController implements Initializable{
    ...
    private void loadAllItems() {
        try {
            ...
            while (rst.next()) {
                ...
                allItems.add(new OrderDTO(rst.getString(1), rst.getString(2), rst.getString(3),  rst.getString(4),rst.getString(5)));
            }
    ...
    boolean updateDeliver() throws ClassNotFoundException, SQLException{
        int flag=0;
        try {
    ...
    public void updateDeliverOnAction(ActionEvent actionEvent) {

        try {
            boolean updateItem = updateDeliver();
    ...
    boolean updatePending() throws ClassNotFoundException, SQLException{
        int flag=0;
        try {
            id=txtCustomerId.getText();
    ...
    public void updatePendingOnAction(ActionEvent actionEvent) {

        try {
            boolean updateItem = updatePending();
